...
const PLATFORMS = [{ value: "twitch", label: "Twitch" }] as const;
        ...
        >
            ...
            >
                ...
                <div className="space-y-2">
                        ...
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div className="text-sm text-gray-500">{streamer.platform}</div>
                                </div>
                                {streamer.isLive && (
                    ...
                    {streamers.length === 0 && (
                        <div className="text-center py-8 text-gray-500">No streamers added yet</div>
                    )}
                </div>
            </TabsContent>
