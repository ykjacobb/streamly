...
import { HomeSimpleDoor, CameraSolid, BookSolid, Settings, FlashSolid, PlaySolid } from "iconoir-react";
    ...
    <div className="w-16 md:w-60 bg-gray-100 dark:bg-zinc-900">
      <div className="flex flex-col h-full">
        ...
        <div className="h-16 flex items-center justify-center md:justify-start px-4">
          <span className="hidden md:block font-bold text-xl text-black dark:text-white">real.kit</span>
        </div>
